...
rosrun kalibr kalibr_calibrate_imu_camera --target checkerboard.yaml --bag ../../save_data/output_down.bag --cam output-camchain.yaml --imu imu.yaml --show-extraction --timeoffset-padding 0.5
